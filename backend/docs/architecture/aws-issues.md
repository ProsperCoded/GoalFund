...
Datadog agent was not able to connect to the host machine, had to use the Datadog agent container to collect the logs and metrics.

Setting up datadog collector and dogstashd was a pain.

- **DogStatsD**: custom metrics sent from your application code
- **Collector**: logs, infrastructure metrics, and APM traces
